        ...
        return __awaiter(this, arguments, void 0, function* (filters = {
            ...
            const hasDisability = filters.hasDisability === true || filters.hasDisability === "true"
                ...
                : filters.hasDisability === false || filters.hasDisability === "false"
                    ? false
                    : null;
            // Initialize pipeline and match conditions
            const pipeline = [];
            const matchOr = [];
            ...
            const transformResults = (items) => items.map((item) => {
                var _a, _b, _c, _d, _e, _f, _g, _h, _j;
                return ({
                    location: item.location || { city: null, country: null },
                    experience: item.experience || [],
                    education: item.education || [],
                    certifications: item.certifications || [],
                    portfolio: item.portfolio || [],
                    id: ((_a = item._id) === null || _a === void 0 ? void 0 : _a.$oid) || null,
                    userId: ((_b = item.userId) === null || _b === void 0 ? void 0 : _b.$oid) || null,
                    bio: item.bio || null,
            ...
            // Random results if no filters or no matches
            if (!matchOr.length || !results.length) {
                const totalCountPipeline = [{ $match: {} }, { $count: "total" }];
                const totalCountResult = yield prisma.$runCommandRaw({
                    aggregate: "JobSeeker",
                    pipeline: totalCountPipeline,
                    cursor: {},
                });
                if ((_d = (_c = totalCountResult === null || totalCountResult === void 0 ? void 0 : totalCountResult.cursor) === null || _c === void 0 ? void 0 : _c.firstBatch) === null || _d === void 0 ? void 0 : _d.length) {
                    total = totalCountResult.cursor.firstBatch[0].total || 0;
                }
                ...
                if ((_f = (_e = randomResult === null || randomResult === void 0 ? void 0 : randomResult.cursor) === null || _e === void 0 ? void 0 : _e.firstBatch) === null || _f === void 0 ? void 0 : _f.length) {
                    results = randomResult.cursor.firstBatch;
                }
            }
            // Transform results
            const transformedData = transformResults(results);
            // Return consistent pagination data
            return {
                page,
                pageSize,
                total,
