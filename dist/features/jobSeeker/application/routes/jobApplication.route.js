...
applicationRoutes.get("/job-applications/:id", authMiddleware_1.authMiddleware, controller.getJobApplications);
applicationRoutes.get("/user-applications/:userId", authMiddleware_1.authMiddleware, controller.getUserApplications);
