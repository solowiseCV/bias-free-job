...
exports.SecurityAndPrivacyController = void 0;
...
class SecurityAndPrivacyController {
    static getSecAndPrivacySet(req, res) {
    ...
    static updateSecAndPrivacySet(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { error } = login_validation_1.loginSchema.validate(req.body);
                if (error) {
...
exports.SecurityAndPrivacyController = SecurityAndPrivacyController;
